...
This mechanism has been integrated into Bitcore-Node-Dreamcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/dreamcoincoin/insight-api-dreamcoin#web-socket-api](https://github.com/dreamcoincoin/insight-api-dreamcoin#web-socket-api) 
* API: [https://github.com/dreamcoincoin/insight-api-dreamcoin#instantsend-transactions](https://github.com/dreamcoincoin/insight-api-dreamcoin#instantsend-transactions) 
...
By default, the Dreamcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Dreamcoin Core daemon:
