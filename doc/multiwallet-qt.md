...
Only requiring some minor changes is dreamcoin.cpp.
...
Changes to dreamcoin.cpp
----------------------
dreamcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
