...
Dreamcoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Dreamcoin Core, where everyone uses
...
pay attention to for reviewers of Dreamcoin Core code.

General Dreamcoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Dreamcoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
