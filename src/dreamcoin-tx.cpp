...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Dreamcoin Core dreamcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  dreamcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dreamcoin transaction") + "\n" +
              "  dreamcoin-tx [options] -create [commands]   " + _("Create hex-encoded dreamcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded dreamcoin transaction
