...
{
    if(fLiteMode) return; // ignore all Dreamcoin related functionality
...
/*
    ...
    allow endless transaction that would bloat Dreamcoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("dreamcoin-privatesend");
