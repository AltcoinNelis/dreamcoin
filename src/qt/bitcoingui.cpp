    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Dreamcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Dreamcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and dreamcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Dreamcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Dreamcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dreamcoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Dreamcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Dreamcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a dreamcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Dreamcoin Core help message to get a list with possible Dreamcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dreamcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Dreamcoin Core"); // default title
    ...
    // Append title to "Dreamcoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
