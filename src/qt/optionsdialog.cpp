    ...
    mapper(0)
{
    ...
    /* Theme selector */
    /*ui->theme->addItem(QString("DREAM-light"), QVariant("light"));*/
    ui->theme->addItem(QString("DREAM-blue"), QVariant("drkblue"));
    /*ui->theme->addItem(QString("DREAM-Crownium"), QVariant("crownium"));*/
    ui->theme->addItem(QString("DREAM-traditional"), QVariant("trad"));
