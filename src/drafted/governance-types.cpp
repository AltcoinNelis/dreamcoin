...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "DreamcoinNetwork") type = DreamcoinNetwork;
    if(strType == "DreamcoinNetworkVariable") type = DreamcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == DreamcoinNetwork) s = "DreamcoinNetwork";
    if(type == DreamcoinNetworkVariable) s = "DreamcoinNetworkVariable";
