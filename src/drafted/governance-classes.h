 ...
 *
 *   // network
 *   CDreamcoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.dreamcoin.site/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CDreamcoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CDreamcoinNetwork(UniValue objIn)
    {
...
// // can be under: DreamcoinNetwork
// //   -- signature requirements : Key1(User)
// class CDreamcoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == DreamcoinNetwork);
//     // }
