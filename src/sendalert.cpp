...
2. run dreamcoind with -printalert or -sendalert like this:
   /path/to/dreamcoind -printalert
...
void ThreadSendAlert()
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.dreamcoin.site";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Dreamcoin Core:0.12.0.58/"));
